...
#include "libavutil/internal.h"			///added by tester
#include "libavutil/intreadwrite.h"
#include "libavutil/dict.h"
#include "libavutil/mathematics.h"
#include "libavutil/pixdesc.h"
#include "libavutil/avstring.h"
#include "libavutil/libm.h"				///added by tester
#include "libavutil/imgutils.h"
#include "libavutil/timestamp.h"
#include "libavutil/bprint.h"
#include "libavutil/time.h"
#include "libavutil/threadmessage.h"
#include "libavcodec/mathops.h"			///added by tester
#include "libavformat/os_support.h"		///added by tester
...
void Initialize()
{
	...
	//parse_loglevel(num, str, options);

	// 	if (num>1 && !strcmp(str[1], "-d")){
	//         run_as_daemon=1;
...
int StartRecord(int num, char **str)
{
    int i, ret;
    int64_t ti;

	//show_banner(num, str, options);

    /* parse options and open all input/output files */
	ret = ffmpeg_parse_options(num, str);
    if (ret < 0)
        exit_program(1);
